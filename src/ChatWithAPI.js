...
import { Text, Modal, Button, TextInput, Image, StyleSheet, View } from 'react-native';
import { Bubble, InputToolbar, Message, MessageText, GiftedChat } from 'react-native-gifted-chat';
    ...
    <View style={styles.container}>
      {apiKeysPresent ? (
        ...
        <View style={styles.blurContainer}>
          <Text style={styles.blurText}>Please add API keys</Text>
        </View>
      )}

      <Modal visible={showModal} animationType="slide">
        <View style={styles.modalContainer}>
          <Text style={styles.modalText}>Please add API keys</Text>
